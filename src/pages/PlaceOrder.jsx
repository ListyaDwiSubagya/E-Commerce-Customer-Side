        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            ...
            <div onClick={() => setMethod('razorpay')} className="flex items-center gap-3 border px-3 p-2 cursor-pointer">
              ...
              <img className="h-5 mx-4" src={assets.razorpay} alt="Stripe" />
            </div>
          ...
          <div className="w-full text-end mt-8">
            <button onClick={() => navigate('/')} type="submit" className="bg-black text-white px-16 py-3 text-sm">PLACE ORDER</button>
          </div>
        </div>
      </div>
    </form>
